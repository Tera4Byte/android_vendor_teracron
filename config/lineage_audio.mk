...
ALARM_PATH := vendor/teracron/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/teracron/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/teracron/prebuilt/common/media/audio/ringtones
